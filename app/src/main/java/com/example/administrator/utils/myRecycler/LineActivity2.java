...
public class LineActivity2 extends AppCompatActivity {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(LineActivity2.this)
                    .inflate(R.layout.line_meizi_item2, parent, false);
            MyViewHolder holder = new MyViewHolder(view);

            //获取屏幕的宽度
            WindowManager wm = (WindowManager) LineActivity2.this
                    .getSystemService(Context.WINDOW_SERVICE);
            //DisplayMetrics 获取手机屏幕分辨率的类
        ...
        public void onBindViewHolder(MyAdapter.MyViewHolder holder, final int position) {
            if (holder.itemView.getScrollX() != 0) {
                //如果item的HorizontalScrollView没在初始位置,则滚动回顶部
                ((HorizontalScrollView) holder.itemView).fullScroll(View.FOCUS_UP);
            }
            ...
            holder.ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    SnackbarUtil.ShortSnackbar(coordinatorLayout, "点击了" + position + "个", SnackbarUtil.Info).show();
                }
            });
        }
