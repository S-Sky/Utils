...
public class CapturingPhotosActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.capturing_photos);
...
//                intent.putExtra(MediaStore.EXTRA_OUTPUT, fileUri);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(LOG_TAG, "onActivityResult: requestCode: " + requestCode + ", resultCode: " + requestCode + ", data: " + data);
        ...
        if (CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE == requestCode) {
            ...
            if (RESULT_OK == resultCode) {
                ...
                if (data != null) {
                    ...
                    // ָ指定了存储路径的时候�intent.putExtra(MediaStore.EXTRA_OUTPUT,fileUri);��
                    ...
                    if (data.hasExtra("data")) {
                        ...
                        imageShow.setImageBitmap(thumbnail);
                    }
                } else {
                    ...
                    int height = imageShow.getHeight();
